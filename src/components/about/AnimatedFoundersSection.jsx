  ...
  return (
    <>
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-br from-[var(--color-primary-DEFAULT)]/5 to-[var(--color-accent-DEFAULT)]/5 rounded-full blur-3xl" />
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-br from-[var(--color-accent-DEFAULT)]/5 to-[var(--color-primary-DEFAULT)]/5 rounded-full blur-3xl" />
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-32 items-center">
              ...
              >
                ...
                >
                  {/* Creative Aura */}
                  {/* Creative Aura */}
                  <div className="absolute -inset-8 bg-gradient-to-br from-[var(--color-primary-DEFAULT)]/10 via-[var(--color-accent-DEFAULT)]/5 to-transparent rounded-[2rem] blur-xl opacity-60" />
              ...
              >
                ...
                >
                  {/* Precision Aura */}
                  <div className="absolute -inset-8 bg-gradient-to-br from-gray-900/10 via-[var(--color-primary-dark)]/5 to-transparent rounded-[2rem] blur-xl opacity-50" />
