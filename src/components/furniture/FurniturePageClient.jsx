        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {materials.map((material) => (
              <div
                key={material.name}
                className="group relative bg-white rounded-xl p-6 border border-gray-200 overflow-hidden transition-shadow duration-300 hover:shadow-lg"
              >
                <Image
                ...
                <div className="relative z-10">
                  <h3 className="text-xl font-bold mb-3 text-[var(--color-primary-DEFAULT)] group-hover:text-white transition-colors duration-500">
                    {material.name}
                  </h3>
